    ...
    <script>
            ...
            $(document).ready(function() {
                $('#MyButton').click(function () {
                    ...
                    // Set up our request
                    XHR.open('DELETE', "{!!  URL::route('api_delete_flight_statistics', $data['carrier_code'])!!}" + "&month=" + month + "&year=" + year + "&airport_code=" + airport_code);
...
<div class="form-style-6">
    <h1>Delete flight statistics</h1>
    <form id="myForm">
